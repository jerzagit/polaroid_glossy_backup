...
const en: Trans = {
  ...
  select_size_title: 'Select Print Size', qty_label: 'How many sets?',
  summary_prints: (p, _q) => `${p} photo${p > 1 ? 's' : ''} × 1 copy each`,
  ...
  cart_item_desc: (p, _q) => `${p} photo${p > 1 ? 's' : ''} × 1 copy each`,
  ...
  checkout_item: (s, p, _q) => `${s} - ${p} photo${p > 1 ? 's' : ''}`,
  ...
  drawer_item: (p, _q) => `${p} photo${p > 1 ? 's' : ''} × 1 copy each`,
  ...
  toast_cart_added: (p, _q) => `${p} photo${p > 1 ? 's' : ''} added to cart!`,
...
const my: Trans = {
  ...
  select_size_title: 'Pilih Saiz Cetakan', qty_label: 'Berapa set?',
  summary_prints: (p, _q) => `${p} foto × 1 cetakan setiap satu`,
  ...
  cart_item_desc: (p, _q) => `${p} foto × 1 cetakan setiap satu`,
  ...
  drawer_item: (p, _q) => `${p} foto × 1 cetakan setiap satu`,
  ...
  toast_cart_added: (p, _q) => `${p} foto telah ditambah ke troli!`,
